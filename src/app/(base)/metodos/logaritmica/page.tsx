    ...
    <div className="relative w-full px-8 pb-8 flex justify-center">
      ...
      >
        ...
        <p className="indent-18"> 
          O ajuste logaritmico é caracterizado pela função: <Latex>{`$g(x) = a \\ln (x) + b$`}</Latex>.
        </p>

        <p className="indent-18">
            Esta função já se encontra em sua forma linearizada. Portanto, podemos usar 
            o <a href="linear" className='underline'>ajuste linear</a> para encontrar os valores de <Latex>$a$ e $b$</Latex>.
            Basta substituir o valor de <Latex>$x$ por $\ln(x)$ no cálculo</Latex>
        </p>
